...
import{getFirestore,doc,collection,getDocs,writeBatch,updateDoc,deleteField}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
...
window.resetMyBoutmeProfile=async()=>{
  ...
  try{
    ...
    await updateDoc(doc(db,'users',user.uid),{
      ...
      extraFields:deleteField(),stories:deleteField(),videos:deleteField()
    });
